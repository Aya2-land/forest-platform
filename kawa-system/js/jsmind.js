    ...
    jm.prototype={
        ...
        mousedown_handle:function(e){
            ...
            if(!!nodeid){
                ...
                // var this_parent_id = selected_node.parent.id;
            ...
            */
            ...
            //  console.log(jmnode[i].type);
                ...
                for(var i=0; i<jmnode.length; i++){
                    ...
                    // jmnode[i].style.border = "0px solid #000";
                    // nishida 兄弟ノードに予測ノードがあるときに出す問い
                    // if(jmnode[i].getAttribute("type") == "predict"){

                    //     if(jmnode[i].getAttribute("parent_id") == this_parent_id){

                    //         // toi_create("論文を読んだことで自分のどのように考えが変化したか？");
                    //         // toi_create("自分と著者の考えの関連性はどこ？");
                    //         // toi_create("自分と著者の考えに食い違いはないか？もしあるなら、自分と著者のどちらが間違っているのか？");
                    //         // toi_create("自分の予測を踏まえて, よりよい結論を生み出せないか？");
                    //         toi_create("自分の言葉で言い換えるとどうなりますか？");
                    //         toi_create("具体例はどのようなものがありますか？");
                    //     }
                    // }else if(jmnode[i].getAttribute("type") == "answer"){
                    //     if(jmnode[i].getAttribute("node_id") == thisId){
                    //         console.log("なんで");
                    //     }
                ...
                for(i=0; i<jmnode.length; i++){
                    ...
                    if(jmnode[i].getAttribute("nodeid") == thisId){
                        ...
                        if(jmnode[i].getAttribute("concept_id") == "1519483811401_n426"){
      
                            checkRationality(nodeid_string,"#ff69b4");
                            
                            // checkRationality("57d804585636950e");
                        ...
                        }else if(jmnode[i].getAttribute("type") == "answer_tag"){
                            // var nodeid_string="57d721dacfc0f4dc"
                            checkRationality(nodeid_string,"#9fd94f");
                        

                        }

                        // if(jmnode[i].getAttribute("type") == "criticism" || jmnode[i].getAttribute("class") == "criticism"){
                        if(jmnode[i].getAttribute("type") == "criticism"){
                            ...
                            if(content == "＊あなたの批評"){
                                ...
                                let position = jmnode[i].getBoundingClientRect();
                                // console.log(position);
                                
                                mm_menu2.style.left = (position.x - document.body.scrollLeft + 20) + 'px';
                                mm_menu2.style.top = (position.y - document.body.scrollTop + 20) + 'px';
                                mm_menu2.classList.add('on');
                                continue;
                        ...
                        // else if(jmnode[i].getAttribute('class') == "interpretation"){
                        //     check_rationality_xmlLoad("interpretation");
                        // }
    ...
    jm.view_provider.prototype={
        ...
        edit_node_end:function(){
            if(this.editing_node != null){
                ...
                // check_node: for(var p=0; p<jmnode.length; p++){
                            
                //     if(new_parent_id == jmnode[p].getAttribute("parent_id") && jmnode[p].getAttribute("type") == "answer"){
                //         break check_node;                      
                //     }else if(p == jmnode.length-1){
                //         // nishida　わからない
                //         var nodeid = jsMind.util.uuid.newid();//idの生成
                //         var topic = '著者の主張';
                //         // var node = _jm.add_node(new_parent_id, nodeid, topic);
                //         console.log("node");
                //         console.log(node);
                ...
                // 子ノードにすでにcriticalノードがない場合，
                // check_node2: for(var j=0; j<jmnode.length; j++){
                //     if(new_parent_id == jmnode[j].getAttribute("parent_id") && jmnode[j].getAttribute("class") == "criticism"){
                //         break check_node2;
                //     }else if(j == jmnode.length-1){
                //         // add_Cnode_parentid(new_parent_id, "");
                //         console.log("批評");
