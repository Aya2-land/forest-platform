...
function CheckClick(){
  ...
  if(check.checked == true){
    $('#jsmind_nav').css('width','65%');
    $('#summary_area').css('width','65%');
    $('#summary_area').css('border-right','solid #F6D4D8 5px');
    $('#summary_area').css('box-sizing', 'border-box');
    // $('#mind').hide();
    // $('#mind').toggle('fast');
    ...
    $('#document').hide();
    $('#mind').show();
    $('jsmind_nav').css('width', '100%');
    $('#summary_area').css('width','100%');
    $('#document_area').toggle('fast');
    // $('.changemode_button').toggle('fast');
  }
}
